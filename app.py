...
def consulta_protocolo():
    try:
        ...
        cursor.execute("SELECT * FROM protocolo WHERE protocolo_externo is not null and dominio='PROTOCOLO_RI' and cast (cadastro as date) between '2023-11-01' and '2023-11-15'")
...
def consulta_certidao():
    try:
        ...
        # Exemplo de consulta filtrando pelo número do protocolo
        cursor.execute("SELECT * FROM protocolo WHERE protocolo_externo is not null and dominio='CERTIDAO_RI' and cast (cadastro as date) between '2023-11-01' and '2023-11-15'")
